...
import { ArrowLeft, Sparkles, FileText, Info, ChevronRight } from 'lucide-react';
...
export function CreateResumePage() {
  ...
  const handleGenerate = async () => {
    ...
    if (rawInput.trim().length < 50) { setError('Please provide more details (at least 50 characters).'); return; }
    ...
    try {
      ...
      if (!session) { setError('Session expired. Please log in again.'); setStep('input'); return; }

      const response = await fetch(`${supabaseUrl}/functions/v1/generate-resume`, {
        method: 'POST',
        headers: {
      ...
      const { data: resume, error: dbError } = await supabase
        ...
        .insert({
          ...
          title: title.trim(),
          raw_input: rawInput,
          personal_info: aiData.personal_info || { name: '', email: '', phone: '', location: '', linkedin: '', website: '' },
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        {step === 'generating' ? (
          <div className="flex flex-col items-center justify-center py-32 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">AI is building your resume...</h2>
            <p className="text-gray-500 max-w-sm">
              Analyzing your experience, generating professional summaries, and structuring your content. This takes about 10-15 seconds.
            </p>
          ...
          <>
            <div className="mb-8">
              ...
              <p className="text-gray-500">Let AI transform your rough notes into a polished, professional resume.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-6">
              ...
              <p className="text-xs text-gray-400 mb-3">Give your resume a name (e.g., "Software Engineer - Google 2024")</p>
              <input
                type="text"
                value={title}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-6">
              <div className="flex items-start justify-between mb-2">
                ...
                <span className="text-xs text-gray-400">{rawInput.length} characters</span>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-amber-800 mb-1">Write all your details in one paragraph including:</p>
                    <ul className="text-xs text-amber-700 space-y-0.5 list-disc list-inside">
                      <li>Name &amp; Role / Title (e.g., Full Stack Developer)</li>
                      <li>Experience: company name, position, time (year), description</li>
                      <li>Education: degree, institution, year</li>
                      <li>Skills (comma-separated)</li>
                      <li>Projects (if any): name, description, technologies</li>
            ...
            <p className="text-xs text-gray-400 text-center mt-3">
              AI uses Google Gemini to analyze your input and generate structured resume content.
            </p>
          </>
        )}
      </main>
